...
public class GUI_Employee extends JFrame implements ActionListener {
    ...
    */ 
        ...
        totalCostLabel.setText("Total: $" + totalCost);
            try { conn.setAutoCommit(false);
                ...
                String upsert = """
                    ...
                    DO UPDATE SET productQuantity = OrderProducts.productQuantity + 1
                    """;
    ...
    /** HELPER FUNCTION THAT RETURNS EACH ROW OF THE PRODUCTS TABLE AS A VECTOR<VECTOR<STRING>>
     * 
    ...
    public void finishOrder(double orderTotal) {
        ...
        String finishOrderString = """
            UPDATE Orders
            SET orderTime = ?, orderTotal = ?, cardPayment = ?
            WHERE orderId = ?
            """;
    ...
    /** HELPER FUNCTION THAT RETREIVES THE MOST RECENT CUSTOMERID 
     * 
    ...
    private void startNewOrderIfNeeded() throws SQLException {
        ...
        String sql = """
            INSERT INTO Orders (employeeId, customerId, orderTime, orderTotal)
            VALUES (?, ?, ?, ?)
            RETURNING orderId
            """;
