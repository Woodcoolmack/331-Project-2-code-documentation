...
/**
 * GUI for editing the ingredients used in a product.
 * 
 * This class permits a Manager to add or remove inventroy items to a product.
 * The class updates productingrdients table in the database. 
 * 
...
public class GUI_productInventory extends JFrame implements ActionListener {
    ...
    /** HELPER FUNCTION TO GET and BUILD INVENTORY ITEM DECREMENT BUTTONS
     * 
     *
     */
    ...
    /** CLOSE
     * 
     * @param e An action event triggered when the return button is clicked.
     */
    @Override
